...
const people = [
  ...
  'Billings, Josh', 'Birrell, Augustine', 'Blair, Tony', 'Beecher, Henry', 'Biondo, Frank'
    ...
    let filteredArr = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600)
    ...
    let aliveTogether = inventors.reduce((acc, curr) => acc + (curr.passed - curr.year), 0)
    ...
    let lastNameAlpha = inventors.sort((a,b) => {
      if (a.last < b.last) {
        return -1
      }
      if (a.last > b.last) {
    ...
    let woo = data.reduce((ac, a) => (ac[a] = ac[a] + 1 || 1 , ac), {})
